...
export default function SubtitleSearch() {
  ...
  return (
    <div className=" selection:bg-cyan-200 bg-white p-4 flex flex-col items-center min-h-screen w-[100%] dark:bg-backgroundColor">
      <h1 className="z-1 text-5xl font-bold mb-4 ">Movie Zone</h1>

      <div className="z-1 h-55 flex slideshow w-full max-w-2xl mx-auto overflow-hidden sm:max-w-[100%] sm:w-screen sm:h-55">
        {loadingRecent ? (
          ...
          <div className="poster flex  sm:max-w-[100%] sm:w-screen sm:h-100">
            {recentMovie.map((movie) => (
              <img
                ...
                hover:border-x-cyan-300 hover:border-t-white dark:hover:border-t-backgroundColor"
              />
            ))}
          </div>
        )}
      ...
      <div className="z-1 searchField h-45  mt-75 items-center flex flex-col absolute">
        <div>
          <input
            type="text"
            value={query}
